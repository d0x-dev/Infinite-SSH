...
♦️ For Debian 9 / 10 / 11 For First Time Installation (Update Repo) <br>
 ...
 apt update -y && apt upgrade -y && apt dist-upgrade -y && reboot
  ```
  ♦️ For Ubuntu 18.04/20.04/22.04/24.04/26.04 For First Time Installation (Update Repo) <br>
...
♦️ Installation Link <br>
  ...
  ```html
apt --fix-missing update && apt update && apt upgrade -y && apt install -y bzip2 gzip coreutils screen dpkg wget vim curl nano zip unzip && wget -q https://raw.githubusercontent.com/d0x-dev/Infinite-SSH/main/setup.sh && chmod +x setup.sh && screen -S setup ./setup.sh
  ```
IPV6 enable
```html
apt --fix-missing update && apt update && apt upgrade -y && apt install -y bzip2 gzip coreutils screen dpkg wget vim curl nano zip unzip && wget -q https://raw.githubusercontent.com/d0x-dev/Infinite-SSH/main/setup2.sh && chmod +x setup2.sh && screen -S setup ./setup2.sh
  ```
<b>
