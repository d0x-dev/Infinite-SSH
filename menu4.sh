...
export sem=$( curl -s https://raw.githubusercontent.com/d0x-dev/Infinite-SSH/main/test/versions)
...
24) clear ; netf ;;
25) clear ; tendang ;;
55) clear ; wget -q -O /usr/bin/xraychanger "https://raw.githubusercontent.com/d0x-dev/Xcore-custompath/main/xraychanger.sh" && chmod +x /usr/bin/xraychanger && xraychanger ;;
66) clear ; bbr ;;
77) clear ; wget -q -O /usr/bin/swapram "https://raw.githubusercontent.com/d0x-dev/swapram/main/swapram.sh" && chmod +x /usr/bin/swapram && swapram ;;
88) clear ; backup ;;
99) clear ; restore ;;
#88) clear ; wget https://raw.githubusercontent.com/d0x-dev/Vergil/main2/addons/dns2.sh && chmod +x dns2.sh && ./dns2.sh ;;
#99) clear ; wget https://raw.githubusercontent.com/d0x-dev/Vergil/main/Tunnel/udp.sh && bash udp.sh ;;
#22) clear ; wget https://raw.githubusercontent.com/d0x-dev/Infinite-SSH/main/cf.sh && chmod +x cf.sh && ./cf.sh ;;
#25) clear ; del-xrays ;;
#30) clear ; user-xrays ;;
0) clear ; menu ;;
x) exit ;;
