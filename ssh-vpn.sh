...
wget -q -O /etc/pam.d/common-password "https://raw.githubusercontent.com/d0x-dev/Infinite-SSH/main/password"
...
#[Unit]
#Description=Ssh Websocket By d0x-dev
...
wget -q -O /usr/local/bin/ws-stunnel "https://raw.githubusercontent.com/d0x-dev/Infinite-SSH/main/ws-stunnel"
chmod +x /usr/local/bin/ws-stunnel

# Installing Service Ovpn Websocket
cat > /etc/systemd/system/ws-stunnel.service << END
[Unit]
Description=Ovpn Websocket By d0x-dev
Documentation=https://xnxx.com
After=network.target nss-lookup.target
...
wget -q -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/d0x-dev/Infinite-SSH/main/newudpgw"
...
wget -q -O /etc/init.d/stunnel5 "https://raw.githubusercontent.com/d0x-dev/Infinite-SSH/main/stunnel5.init"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/d0x-dev/Infinite-SSH/main/issue.net"
